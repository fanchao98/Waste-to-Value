...
namespace msa {
    namespace mcts {
        ...
        public:
            ...
            TreeNodeT* expand(vector<vector<Point_3>> all_vertices_in_components, int num_first_plane_components) {
                ...
                if(actions.empty()) {
                    ...
                    state.get_actions(actions, all_vertices_in_components, num_first_plane_components,new_current_points);
            ...
            bool is_terminal_2() const { return state.is_terminal_2(); }
