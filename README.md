...
# Dependency
This project is written in C++. You should install **CGAL(5.5.1)**, **opencv**, **libigl**, **boost(1_80_0)**, and include "glpk-5.0\src", before compiling this project. I recommend using Visual Studio 2022.
# Start
